...
class Cartão:
    def __init__(self, id, id_conta, tipo):
        self.__id = id
    ...
    def __str__(self):
        return f"ID = {self.__id} - IdConta = {self.__idConta} - Tipo = {self.__tipo}"
        ...
        try:
            with open("Sistema/Jso/Cartões.json", mode="r") as arquivo:
                ...
                for obj in objetos_json:
                    card = Cartão(obj["_Cartão_id"], obj["_Cartão_idConta"], obj["_Cartão_tipo"])
