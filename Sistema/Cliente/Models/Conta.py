...
class Contas(Modelo):
    ...
    def abrir(cls):
        cls.objetos = []
        try:
            with open("/workspaces/SistemaBancario/Sistema/Json/contas.json", mode="r") as arquivo:
    ...
    @classmethod
    def salvar(cls):
        with open("/workspaces/SistemaBancario/Sistema/Json/contas.json", mode="w") as arquivo:
